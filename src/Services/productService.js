...
export async function getProducts()  {
    return fetch(`http://localhost:8000/api/v1/products`,
    {
        ...
        "Access-Control-Allow-Origin":"http://localhost:8000/api/v1/products"
...
export async function getMyProducts()  {
    return fetch(`http://localhost:8000/api/v1/me/products`,
    {
        method: 'GET',
        mode: 'cors',
        headers: { 
...
export async function createMyProduct(data)  {
    return fetch(`http://localhost:8000/api/v1/me/products`,
    {
        ...
        "Authorization": `Bearer ${token}`,
        "Content-Type": "application/json",
        "Access-Control-Allow-Origin":"http://localhost:8000/api/v1/me/products"
        },
...
export async function updateMyProduct(id, data)  {
    return fetch(`http://localhost:8000/api/v1/me/products/${id}`,
    {
        method: 'PATCH',
        mode: 'cors',
        headers: { 
